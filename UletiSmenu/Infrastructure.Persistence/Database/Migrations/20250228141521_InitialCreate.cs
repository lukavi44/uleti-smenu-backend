        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PIB = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    MB = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SubscriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SubscriptionStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SubscriptionStop = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_Position",
                table: "JobPosts",
                column: "Position");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_Salary",
                table: "JobPosts",
                column: "Salary");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_StartingDate",
                table: "JobPosts",
                column: "StartingDate");

            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_Cost",
                table: "Subscriptions",
                column: "Cost");

            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_DurationInDays",
                table: "Subscriptions",
