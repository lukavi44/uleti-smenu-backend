...
namespace Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20250529123306_AddFavouritesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeEmployer", b =>
                {
                    b.Property<Guid>("FavoriteEmployersId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FollowersId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FavoriteEmployersId", "FollowersId");
            ...
            modelBuilder.Entity("EmployeeEmployer", b =>
                {
                    b.HasOne("Core.Models.Entities.Employer", null)
                        .WithMany()
                        .HasForeignKey("FavoriteEmployersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
