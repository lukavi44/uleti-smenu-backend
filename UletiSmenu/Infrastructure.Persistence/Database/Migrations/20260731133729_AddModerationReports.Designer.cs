...
namespace Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260731133729_AddModerationReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.ContactMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.ConversationReadState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.GeographyCity", b =>
                {
                    ...
                    b.HasIndex("RegionCode", "Name");

                    b.ToTable("GeographyCities", (string)null);
                });

            modelBuilder.Entity("Core.Models.Entities.GeographyCountry", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(2)
                    ...
                    b.ToTable("GeographyCountries", (string)null);
                });

            modelBuilder.Entity("Core.Models.Entities.GeographyRegion", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("GeographyRegions", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Models.Entities.MatchReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.ModerationReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "JobPostId", "Type")
                        .IsUnique();

                    b.ToTable("Notifications", (string)null);
                });

            modelBuilder.Entity("Core.Models.Entities.PaymentEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.RestaurantLocation", b =>
                {
                    ...
                    b.Property<string>("GeographyCityCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("GeographyCountryCode")
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)");

                    b.Property<string>("GeographyRegionCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("GeographyCityCode");

                    b.HasIndex("GeographyCountryCode");
            ...
            modelBuilder.Entity("Core.Models.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("NotifyEmailApplicationReceived")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyEmailFavouriteJobPost")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyInAppApplicationAccepted")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyInAppApplicationDeclined")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyInAppApplicationReceived")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyInAppFavouriteJobPost")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyInAppReviewReminder")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Models.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.WorkExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Models.Entities.Employer", b =>
                {
                    ...
                    b.Property<bool>("IsVerifiedEmployer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Core.Models.Entities.GeographyCity", b =>
                {
                    b.HasOne("Core.Models.Entities.GeographyRegion", "Region")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Core.Models.Entities.GeographyRegion", b =>
                {
                    b.HasOne("Core.Models.Entities.GeographyCountry", "Country")
                        .WithMany("Regions")
            ...
            modelBuilder.Entity("Core.Models.Entities.RestaurantLocation", b =>
                {
                    ...
                    b.Navigation("GeographyCity");

                    b.Navigation("GeographyCountry");

                    b.Navigation("GeographyRegion");
                });
                    ...
                    b.OwnsOne("Core.Models.ValueObjects.Address", "Address", b1 =>
                        {
                            ...
                            b1.OwnsOne("Core.Models.ValueObjects.City", "City", b2 =>
                                {
                                    b2.Property<Guid>("AddressEmployerId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("AddressEmployerId");

                                    b2.ToTable("AspNetUsers");

                                    b2.WithOwner()
                                        .HasForeignKey("AddressEmployerId");

                                    b2.OwnsOne("Core.Models.ValueObjects.Country", "Country", b3 =>
                                        {
                                            b3.Property<Guid>("CityAddressEmployerId")
                                                .HasColumnType("uniqueidentifier");
                                            ...
                                            b3.HasKey("CityAddressEmployerId");

                                            b3.ToTable("AspNetUsers");

                                            b3.WithOwner()
                                                .HasForeignKey("CityAddressEmployerId");
                                        });
