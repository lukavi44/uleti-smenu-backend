...
$BasicMonthlyPriceId = "price_REPLACE_ME"
$UnlimitedMonthlyPriceId = "price_REPLACE_ME"
...
dotnet user-secrets set "Stripe:PriceIds:BasicMonthly" $BasicMonthlyPriceId --project $ApiProject
dotnet user-secrets set "Stripe:PriceIds:UnlimitedMonthly" $UnlimitedMonthlyPriceId --project $ApiProject
